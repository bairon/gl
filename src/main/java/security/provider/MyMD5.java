...
import static security.provider.MyByteArrayAccess.*;

public final class MyMD5 extends MyDigestBase {
	...
	// Standard constructor, creates a new MyMD5 instance.
	public MyMD5() {
		super("MyMD5", 16, 64);
		state = new int[4];
		x = new int[16];
	...
	/* **********************************************************
			* The MyMD5 Functions. The results of this
	...
	/**
	 * This is where the functions come together as the generic MyMD5
